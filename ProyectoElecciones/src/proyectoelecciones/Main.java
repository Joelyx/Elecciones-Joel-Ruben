...
public class Main {
    ...
    public static void asignarDiputados() {
        Scanner sc = new Scanner(System.in);

        boolean salir = false;

        do {
            System.out.println("¿En que eleccion quieres asignar los diputados?");
            ...
            if (opcionEleccion == 0) {
                ...
                eleccionSeleccionada.asignarDiputados();
                salir = true;
            }
        } while (salir == false);
    ...
    public static void main(String[] args) {
        ...
        do {
            System.out.println("Menu elecciones  \n"
                    ...
                    + "2. Crear elecciones. \n"
                    + "3. Añadir partido. \n"
                    + "4. Ver asignaciones de diputados \n"
                    + "5. Salir");
